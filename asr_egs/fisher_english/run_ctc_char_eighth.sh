...
if [ $stage -le 3 ]; then
  ...
  utils/subset_data_dir_tr_cv.sh --cv-spk-percent 88 data/train_600k data/train_75k data/extra;

  utils/subset_data_dir_tr_cv.sh --cv-spk-percent 20 data/train_75k data/train_tr80 data/test_deval;
...
if [ $stage -le 4 ]; then
  ...
  dir=exp/train_char_eigth_l${lstm_layer_num}_c${lstm_cell_dim}   # working directory
  mkdir -p $dir
